...
ESMF_VERSION_STRING_GIT=ESMF_8_1_0_beta_snapshot_47-18-g3fd6502904
#----------------------------------------------
...
ESMF_APPSDIR=/project/esmf/himanshu/release_8.1.0/pgi/esmf/apps/appsO/Linux.pgi.64.mpiuni.default
ESMF_LIBSDIR=/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/project/esmf/himanshu/release_8.1.0/pgi/esmf/mod/modO/Linux.pgi.64.mpiuni.default -I/project/esmf/himanshu/release_8.1.0/pgi/esmf/src/include -I/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/include -I/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_47-18-g3fd6502904' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/project/esmf/himanshu/release_8.1.0/pgi/esmf -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=20 -DESMF_PGIVERSION_MINOR=1 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE
...
ESMF_F90LINKPATHS=-L/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_F90ESMFLINKPATHS=-L/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/project/esmf/himanshu/release_8.1.0/pgi/esmf/src/include  -I/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/include -I/project/esmf/himanshu/release_8.1.0/pgi/esmf/src/Infrastructure/stubs/mpiuni -I/project/esmf/himanshu/release_8.1.0/pgi/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_47-18-g3fd6502904' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/project/esmf/himanshu/release_8.1.0/pgi/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=20 -DESMF_PGIVERSION_MINOR=1 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE

ESMF_CXXLINKOPTS=  -lpthread -Wl,--no-as-needed
ESMF_CXXLINKPATHS=-L/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_CXXESMFLINKPATHS=-L/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libO/Linux.pgi.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/project/esmf/himanshu/release_8.1.0/pgi/esmf

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /project/esmf/himanshu/release_8.1.0/pgi/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: pgi
