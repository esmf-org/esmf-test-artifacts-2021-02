...
ESMF_APPSDIR=/project/esmf/himanshu/release_8.1.0/pgi/esmf/apps/appsg/Linux.pgi.64.mpiuni.default
ESMF_LIBSDIR=/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/project/esmf/himanshu/release_8.1.0/pgi/esmf/mod/modg/Linux.pgi.64.mpiuni.default -I/project/esmf/himanshu/release_8.1.0/pgi/esmf/src/include -I/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/include -I/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/include
...
ESMF_F90LINKPATHS=-L/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_F90ESMFLINKPATHS=-L/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_CXXLINKPATHS=-L/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -L/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_CXXESMFLINKPATHS=-L/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/hdf5-1.12.0-gcc-g++-gfortran-9.3.0/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-pgi-pgcc-pghf-20.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-20.1/linux86-64-llvm/20.1/libso
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/project/esmf/himanshu/release_8.1.0/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default/libesmftrace_preload.so
