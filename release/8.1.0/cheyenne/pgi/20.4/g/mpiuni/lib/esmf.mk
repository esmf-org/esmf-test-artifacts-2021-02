...
ESMF_APPSDIR=/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/apps/appsg/Linux.pgi.64.mpiuni.default
ESMF_LIBSDIR=/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_F90LINKPATHS=-L/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4//lib -L/glade/u/apps/opt/pgi/20.4/linux86-64-llvm/20.4/libso
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4//lib -Wl,-rpath,/glade/u/apps/opt/pgi/20.4/linux86-64-llvm/20.4/libso
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/src/include  -I/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/include -I/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/src/Infrastructure/stubs/mpiuni -I/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_47-4-g0d177ef04f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/glade/scratch/himanshu/relese_8.1.0/PGI/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=20 -DESMF_PGIVERSION_MINOR=4 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE

ESMF_CXXLINKOPTS=  -lpthread -Wl,--no-as-needed
ESMF_CXXLINKPATHS=-L/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4//lib -L/glade/u/apps/opt/pgi/20.4/linux86-64-llvm/20.4/libso
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/20.4//lib -Wl,-rpath,/glade/u/apps/opt/pgi/20.4/linux86-64-llvm/20.4/libso
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/himanshu/relese_8.1.0/PGI/esmf/lib/libg/Linux.pgi.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/himanshu/relese_8.1.0/PGI/esmf

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/himanshu/relese_8.1.0/PGI/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: pgi
