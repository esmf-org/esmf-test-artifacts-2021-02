...
ESMF_APPSDIR=/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/apps/appsO/Linux.intel.64.openmpi.default
ESMF_LIBSDIR=/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default
...
ESMF_F90LINKPATHS=-L/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default  
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/src/include   -I/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_47' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=openmpi -DESMF_DIR=/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_SIGUSR2

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default  -L/glade/u/apps/opt/intel/2019u5/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default  -Wl,-rpath,/glade/u/apps/opt/intel/2019u5/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default
ESMF_CXXLINKLIBS= -lmpi_mpifh -lsz -lz -limf -lm -ldl -lrt -ldl -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
ESMF_CXXESMFLINKLIBS=-lesmf  -lmpi_mpifh -lsz -lz -limf -lm -ldl -lrt -ldl -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O/lib/libO/Linux.intel.64.openmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/himanshu/relese_8.1.0/python_data/intel_19.0.5.281_openmpi_O
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
