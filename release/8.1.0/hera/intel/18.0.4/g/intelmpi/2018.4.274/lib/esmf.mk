...
ESMF_APPSDIR=/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/apps/appsg/Linux.intel.64.intelmpi.default
ESMF_LIBSDIR=/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default
...
ESMF_F90LINKPATHS=-L/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default -L/apps/netcdf/4.7.0/intel/18.0.5.274/lib -L/apps/netcdf/4.7.0/intel/18.0.5.274/lib -L/apps/netcdf/4.7.0/intel/18.0.5.274/lib -L/apps/hdf5/1.10.5/intel/18.0.5.274/lib -L/apps/szip/2.1/lib 
ESMF_F90ESMFLINKPATHS=-L/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default -Wl,-rpath,/apps/netcdf/4.7.0/intel/18.0.5.274/lib -Wl,-rpath,/apps/netcdf/4.7.0/intel/18.0.5.274/lib -Wl,-rpath,/apps/netcdf/4.7.0/intel/18.0.5.274/lib -Wl,-rpath,/apps/hdf5/1.10.5/intel/18.0.5.274/lib -Wl,-rpath,/apps/szip/2.1/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/src/include  -I/apps/netcdf/4.7.0/intel/18.0.5.274/include -I/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_44-104-g0d177ef04f' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=intelmpi -DESMF_DIR=/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default -L/apps/netcdf/4.7.0/intel/18.0.5.274/lib -L/apps/netcdf/4.7.0/intel/18.0.5.274/lib -L/apps/netcdf/4.7.0/intel/18.0.5.274/lib -L/apps/hdf5/1.10.5/intel/18.0.5.274/lib -L/apps/szip/2.1/lib -L/apps/intel/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default -Wl,-rpath,/apps/netcdf/4.7.0/intel/18.0.5.274/lib -Wl,-rpath,/apps/netcdf/4.7.0/intel/18.0.5.274/lib -Wl,-rpath,/apps/netcdf/4.7.0/intel/18.0.5.274/lib -Wl,-rpath,/apps/hdf5/1.10.5/intel/18.0.5.274/lib -Wl,-rpath,/apps/szip/2.1/lib -Wl,-rpath,/apps/intel/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default
...
ESMF_TRACE_LDPRELOAD=/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g/lib/libg/Linux.intel.64.intelmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch1/NCEPDEV/da/Mark.Potts/intel_18.0.4_intelmpi_g
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
