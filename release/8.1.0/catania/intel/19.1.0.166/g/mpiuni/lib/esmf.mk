...
ESMF_APPSDIR=/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/apps/appsg/Darwin.intel.64.mpiuni.default
ESMF_LIBSDIR=/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default
...
ESMF_F90LINKPATHS=-L/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default -L/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/lib -L/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/lib -L/project/esmf/Intel/19.1.0.166/lib -L/usr/lib
ESMF_F90ESMFLINKPATHS=-L/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default -Wl,-rpath,/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/lib -Wl,-rpath,/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/src/include  -I/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/include -I/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/src/Infrastructure/stubs/mpiuni -I/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_47-18-g3fd6502904' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Darwin=1 -DESMF_COMM=mpiuni -DESMF_DIR=/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI

ESMF_CXXLINKOPTS=  -m64 -pthread  -qopenmp
ESMF_CXXLINKPATHS=-L/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default -L/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/lib -L/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/lib -L/opt/intel/compilers_and_libraries_2020.0.166/mac/compiler/lib/
ESMF_CXXESMFLINKPATHS=-L/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default -Wl,-rpath,/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/lib -Wl,-rpath,/project/esmf/Intel/19.1.0.166/netcdf/4.7.4/lib -Wl,-rpath,/opt/intel/compilers_and_libraries_2020.0.166/mac/compiler/lib/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/esmf_test/cronjobs/release_8.1.0/intel/esmf/lib/libg/Darwin.intel.64.mpiuni.default
ESMF_CXXLINKLIBS= -lifportmt -lifcoremt -limf -lsvml -lipgo -liomp5 -lSystem -lintlc -lpthread -lsvml -ldl -lnetcdf -lnetcdff
ESMF_CXXESMFLINKLIBS=-lesmf  -lifportmt -lifcoremt -limf -lsvml -lipgo -liomp5 -lSystem -lintlc -lpthread -lsvml -ldl -lnetcdf -lnetcdff
