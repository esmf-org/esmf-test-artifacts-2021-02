...
ESMF_F90COMPILEOPTS=-fallow-argument-mismatch -fallow-invalid-boz -fallow-argument-mismatch -fallow-invalid-boz -O   -m64 -mcmodel=small -ffree-line-length-none  -fopenmp
...
ESMF_CXXCOMPILEOPTS=-fallow-argument-mismatch -std=c++11 -O -DNDEBUG  -DESMF_LOWERCASE_SINGLEUNDERSCORE -m64 -mcmodel=small  -fopenmp
