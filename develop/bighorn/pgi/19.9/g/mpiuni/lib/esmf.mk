...
ESMF_APPSDIR=/scratch/esmf/manual/pgi_mpiuni/esmf/apps/appsg/Linux.pgi.64.mpiuni.default
ESMF_LIBSDIR=/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/scratch/esmf/manual/pgi_mpiuni/esmf/mod/modg/Linux.pgi.64.mpiuni.default -I/scratch/esmf/manual/pgi_mpiuni/esmf/src/include -I/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/include -I/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/include
...
ESMF_F90LINKPATHS=-L/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/pgi-pgcc-pgf-19.9/linux86-64-llvm/19.9/libso
ESMF_F90ESMFLINKPATHS=-L/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-19.9/linux86-64-llvm/19.9/libso
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch/esmf/manual/pgi_mpiuni/esmf/src/include  -I/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/include -I/scratch/esmf/manual/pgi_mpiuni/esmf/src/Infrastructure/stubs/mpiuni -I/scratch/esmf/manual/pgi_mpiuni/esmf/src/prologue/yaml-cpp/include
...
ESMF_CXXLINKPATHS=-L/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/pgi-pgcc-pgf-19.9/linux86-64-llvm/19.9/libso
ESMF_CXXESMFLINKPATHS=-L/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-19.9/linux86-64-llvm/19.9/libso
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/scratch/esmf/manual/pgi_mpiuni/esmf/lib/libg/Linux.pgi.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch/esmf/manual/pgi_mpiuni/esmf

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch/esmf/manual/pgi_mpiuni/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: pgi
