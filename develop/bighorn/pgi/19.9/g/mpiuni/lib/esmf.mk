...
ESMF_VERSION_STRING_GIT=ESMF_8_1_0_beta_snapshot_38
#----------------------------------------------
...
ESMF_APPSDIR=/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/apps/appsg/Linux.pgi.64.mpiuni.default
ESMF_LIBSDIR=/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/mod/modg/Linux.pgi.64.mpiuni.default -I/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/src/include -I/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/include -I/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_38' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=19 -DESMF_PGIVERSION_MINOR=9 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE
...
ESMF_F90LINKPATHS=-L/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/pgi-pgcc-pgf-19.9/linux86-64-llvm/19.9/libso
ESMF_F90ESMFLINKPATHS=-L/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-19.9/linux86-64-llvm/19.9/libso
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/src/include  -I/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/include -I/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/src/Infrastructure/stubs/mpiuni -I/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_38' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI -DESMF_PGIVERSION_MAJOR=19 -DESMF_PGIVERSION_MINOR=9 -DESMF_PGIVERSION_PATCH=0 -DESMF_NO_F2018ASSUMEDTYPE

ESMF_CXXLINKOPTS=  -lpthread -Wl,--no-as-needed
ESMF_CXXLINKPATHS=-L/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/lib -L/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -L/usr/local/pgi-pgcc-pgf-19.9/linux86-64-llvm/19.9/libso
ESMF_CXXESMFLINKPATHS=-L/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/lib -Wl,-rpath,/usr/local/netcdf-c-4.6.1-f-4.4.4-pgi-pgcc-pgf-18.1/lib -Wl,-rpath,/usr/local/pgi-pgcc-pgf-19.9/linux86-64-llvm/19.9/libso
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf/lib/libg/Linux.pgi.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch/esmf/esmf_test/cronjobs/trunk/pgi/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: pgi
