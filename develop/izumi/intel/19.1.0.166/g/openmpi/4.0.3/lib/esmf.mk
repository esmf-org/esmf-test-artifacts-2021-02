...
ESMF_APPSDIR=/project/esmf/himanshu/intel/esmf/apps/appsg/Linux.intel.64.openmpi.default
ESMF_LIBSDIR=/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default
...
ESMF_F90COMPILEPATHS=-I/project/esmf/himanshu/intel/esmf/mod/modg/Linux.intel.64.openmpi.default -I/project/esmf/himanshu/intel/esmf/src/include 
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_36-23-g5b3af8aac9' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=openmpi -DESMF_DIR=/project/esmf/himanshu/intel/esmf
ESMF_F90COMPILEFREECPP=
ESMF_F90COMPILEFREENOCPP=
ESMF_F90COMPILEFIXCPP=
ESMF_F90COMPILEFIXNOCPP=

ESMF_F90LINKOPTS=-lnl-3 -lfabric  -m64 -mcmodel=small -pthread -threads -Wl,--no-as-needed  -qopenmp
ESMF_F90LINKPATHS=-L/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default  
ESMF_F90ESMFLINKPATHS=-L/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default
...
ESMF_CXXCOMPILEPATHS= -I/project/esmf/himanshu/intel/esmf/src/include   -I/project/esmf/himanshu/intel/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_1_0_beta_snapshot_36-23-g5b3af8aac9' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=openmpi -DESMF_DIR=/project/esmf/himanshu/intel/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_SIGUSR2

ESMF_CXXLINKOPTS=-lnl-3 -lfabric  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default  -L/usr/local/intel-cluster-20.0.1/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default  -Wl,-rpath,/usr/local/intel-cluster-20.0.1/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default
ESMF_CXXLINKLIBS= -lmpi_mpifh -lopen-rte -lopen-pal -limf -lm -ludev -libverbs -lrdmacm -lz -lrt -ltorque -lpsm2 -lutil -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -ldl -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
ESMF_CXXESMFLINKLIBS=-lesmf  -lmpi_mpifh -lopen-rte -lopen-pal -limf -lm -ludev -libverbs -lrdmacm -lz -lrt -ltorque -lpsm2 -lutil -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -ldl -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
...
ESMF_TRACE_LDPRELOAD=/project/esmf/himanshu/intel/esmf/lib/libg/Linux.intel.64.openmpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/project/esmf/himanshu/intel/esmf

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /project/esmf/himanshu/intel/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
