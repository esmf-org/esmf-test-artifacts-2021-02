...
ESMF_APPSDIR=/project/esmf/himanshu/intel/esmf/apps/appsO/Linux.intel.64.openmpi.default
ESMF_LIBSDIR=/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default
...
ESMF_F90COMPILEPATHS=-I/project/esmf/himanshu/intel/esmf/mod/modO/Linux.intel.64.openmpi.default -I/project/esmf/himanshu/intel/esmf/src/include 
...
ESMF_F90LINKPATHS=-L/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default  
ESMF_F90ESMFLINKPATHS=-L/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default
...
ESMF_CXXLINKPATHS=-L/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default  -L/usr/local/intel-cluster-20.0.1/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default  -Wl,-rpath,/usr/local/intel-cluster-20.0.1/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default
ESMF_CXXLINKLIBS= -lmpi_mpifh -lopen-rte -lopen-pal -limf -lm -ludev -libverbs -lrdmacm -lz -lrt -ltorque -lpsm2 -lutil -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
ESMF_CXXESMFLINKLIBS=-lesmf  -lmpi_mpifh -lopen-rte -lopen-pal -limf -lm -ludev -libverbs -lrdmacm -lz -lrt -ltorque -lpsm2 -lutil -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
...
ESMF_TRACE_LDPRELOAD=/project/esmf/himanshu/intel/esmf/lib/libO/Linux.intel.64.openmpi.default/libesmftrace_preload.so
