...
ESMF_APPSDIR=/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/apps/appsO/Linux.pgi.64.mpiuni.default
ESMF_LIBSDIR=/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/mod/modO/Linux.pgi.64.mpiuni.default -I/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/src/include -I/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/include -I/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/include
...
ESMF_F90LINKPATHS=-L/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/lib -L/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9//lib -L/glade/u/apps/ch/opt/pgi/19.9/linux86-64-llvm/19.9/libso
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9//lib -Wl,-rpath,/glade/u/apps/ch/opt/pgi/19.9/linux86-64-llvm/19.9/libso
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/src/include  -I/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/include -I/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/src/Infrastructure/stubs/mpiuni -I/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/src/prologue/yaml-cpp/include
...
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9//lib -Wl,-rpath,/glade/u/apps/ch/opt/pgi/19.9/linux86-64-llvm/19.9/libso
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/himanshu/manual/pgi_mpiuni/esmf/lib/libO/Linux.pgi.64.mpiuni.default/libesmftrace_preload.so
...
# ESMF_NETCDF_INCLUDE:    /glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/include
# ESMF_NETCDF_LIBS:       -lnetcdf
# ESMF_NETCDF_LIBPATH:    /glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/lib
# ESMF_NFCONFIG:          nf-config
# ESMF_NETCDFF_INCLUDE:   /glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/include
# ESMF_NETCDFF_LIBS:      -lnetcdff -lnetcdf -lnetcdf
# ESMF_NETCDFF_LIBPATH:   /glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9/lib /glade/u/apps/ch/opt/netcdf/4.7.3/pgi/19.9//lib
