...
ESMF_APPSDIR=/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/apps/appsO/Linux.intel.64.openmpi.default
ESMF_LIBSDIR=/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default
...
ESMF_F90COMPILEPATHS=-I/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/mod/modO/Linux.intel.64.openmpi.default -I/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/src/include 
...
ESMF_F90LINKPATHS=-L/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default  
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default
...
ESMF_CXXLINKPATHS=-L/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default  -L/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default  -Wl,-rpath,/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default
ESMF_CXXLINKLIBS= -lmpi_mpifh -lsz -lz -limf -lm -ldl -limf -lm -ldl -lrt -ldl -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
ESMF_CXXESMFLINKLIBS=-lesmf  -lmpi_mpifh -lsz -lz -limf -lm -ldl -limf -lm -ldl -lrt -ldl -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libO/Linux.intel.64.openmpi.default/libesmftrace_preload.so
