...
ESMF_APPSDIR=/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/apps/appsg/Linux.intel.64.mpt.default
ESMF_LIBSDIR=/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default
...
ESMF_F90COMPILEPATHS=-I/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/mod/modg/Linux.intel.64.mpt.default -I/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/src/include 
...
ESMF_F90LINKPATHS=-L/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default  
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default
ESMF_F90LINKLIBS= -lmpi++ -cxxlib -lrt -ldl
ESMF_F90ESMFLINKLIBS=-lesmf  -lmpi++ -cxxlib -lrt -ldl
...
ESMF_CXXLINKPATHS=-L/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default  -L/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default  -Wl,-rpath,/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default
ESMF_CXXLINKLIBS= -lsz -lz -limf -lm -ldl -lrt -ldl -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -ldl -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
ESMF_CXXESMFLINKLIBS=-lesmf  -lsz -lz -limf -lm -ldl -lrt -ldl -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -liomp5 -lintlc -lpthread -lsvml -ldl -lgcc -lgcc_s -lirc_s -ldl -lrt -ldl
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/himanshu/scripts_dir/daily/intel_cheyenne/esmf/lib/libg/Linux.intel.64.mpt.default/libesmftrace_preload.so
